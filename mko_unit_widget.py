...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.AWLabel.setGeometry(QtCore.QRect(90, 70, 21, 21))
        self.AWLabel.setObjectName("AWLabel")
        self.RWBox = QtWidgets.QComboBox(Frame)
        self.RWBox.setGeometry(QtCore.QRect(170, 70, 61, 20))
        self.RWBox.setObjectName("RWBox")
        self.RWBox.addItem("")
        self.RWBox.addItem("")
        self.AddrSpinBox = QtWidgets.QSpinBox(Frame)
        self.AddrSpinBox.setGeometry(QtCore.QRect(50, 30, 42, 22))
        ...
        self.SubaddrLabel.setGeometry(QtCore.QRect(110, 30, 51, 21))
        self.SubaddrLabel.setObjectName("SubaddrLabel")
        self.DataTable = QtWidgets.QTableWidget(Frame)
        self.DataTable.setGeometry(QtCore.QRect(320, 0, 401, 101))
        ...
        self.DataTable.verticalHeader().setDefaultSectionSize(18)
        self.AddresLabel = QtWidgets.QLabel(Frame)
        self.AddresLabel.setGeometry(QtCore.QRect(10, 30, 41, 21))
        self.AddresLabel.setObjectName("AddresLabel")
        self.label = QtWidgets.QLabel(Frame)
        self.label.setGeometry(QtCore.QRect(0, 0, 31, 21))
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.line = QtWidgets.QFrame(Frame)
        self.line.setGeometry(QtCore.QRect(10, 100, 711, 20))
