...
//            pEvD->sub.tmk.dwTimer = *((DWORD*)(&_awVTMK4OutBuf[4]));
          break;
        }
      break;
    }
  ...
  else
  {
    ...
    switch (pEvD->wMode)
    {
      case BC_MODE:
	    ...
	    {
          case 1:
            pEvD->sub.bc.wResult = evd_s.awEvData[0];
          break;
          case 2:
            pEvD->sub.bc.wResult = evd_s.awEvData[0];
            pEvD->sub.bc.wAW1 = evd_s.awEvData[1];
            pEvD->sub.bc.wAW2 = evd_s.awEvData[2];
          break;
          case 3:
            pEvD->sub.bcx.wResultX = evd_s.awEvData[0];
            pEvD->sub.bcx.wBase = evd_s.awEvData[1];
          break;
          case 4:
            pEvD->sub.bcx.wBase = evd_s.awEvData[0];
          break;
        }
      break;
      case MT_MODE:
        ...
        {
          case 3:
            pEvD->sub.mt.wResultX = evd_s.awEvData[0];
            pEvD->sub.mt.wBase = evd_s.awEvData[1];
          break;
          case 4:
            pEvD->sub.mt.wBase = evd_s.awEvData[0];
          break;
        }
      break;
      case RT_MODE:
        ...
        {
          case 1:
            pEvD->sub.rt.wCmd = evd_s.awEvData[0];
          break;
          case 2:
          case 3:
           pEvD->sub.rt.wStatus = evd_s.awEvData[0];
          break;
        }
      break;
      case UNDEFINED_MODE:
        ...
        {
          case 5:
            pEvD->sub.tmk.wRequest = evd_s.awEvData[0];
//            pEvD->sub.tmk.dwTimer = *((DWORD*)(&_awVTMK4OutBuf[4]));
          break;
          case 255:
            pEvD->sub.raw.wData1 = evd_s.awEvData[0];
            pEvD->sub.raw.wData2 = evd_s.awEvData[1];
          break;
        }
      break;
    }
